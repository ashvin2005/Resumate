...
const testimonials = [
  {
    ...
    content:
      "Resumate helped me identify gaps in my resume I never noticed. Landed 3x more interviews after using their suggestions!",
    avatar: "👩‍💻",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    role: "HR Manager",
    content:
      "I recommend Resumate to all candidates we interview - the quality improvement is remarkable.",
    avatar: "👩‍💼",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    content:
      "My response rate doubled after using Resumate's optimization tools.",
    avatar: "👩‍🎨",
  },
  {
    id: 11,
  ...
  },
  {
    ...
    role: "CTO",
    content:
      "We evaluate hundreds of resumes weekly - Resumate-optimized ones always stand out.",
    avatar: "👨‍💼",
  },
  {
    id: 14,
    ...
    content:
      "I can immediately tell when a candidate has used Resumate - the quality difference is obvious.",
    avatar: "👩‍💼",
  },
  {
    id: 15,
